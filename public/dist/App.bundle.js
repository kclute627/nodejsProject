...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    var hearted = _this.heart.classList.toggle("heart__button--hearted");
...
function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 41.8;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -87.6;
    ...
    _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (res) {
        ...
        var markers = places.map(function (cur) {
            var _cur$location$coordin = _slicedToArray(cur.location.coordinates, 2),
                placeLng = _cur$location$coordin[0],
                placeLat = _cur$location$coordin[1];
...
function searchResultsHTML(stores) {
  return stores.map(function (cur) {
    return " \n            <a href='/store/" + cur.slug + "' class=\"search__result\">\n              <strong>" + cur.name + "</strong>   \n            </a>\n            \n        \n        ";
  }).join("");
}
...
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    // if they are not pressing up, down or enter {
